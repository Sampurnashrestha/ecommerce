    ...
    <section className="w-full min-h-[950px] md:min-h-screen bg-black/40 backdrop-blur-sm px-6 md:px-20 pt-[7rem] pb-24 text-white">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 space-y-6 shadow-lg">
          <h2 className="text-3xl font-tinos font-semibold">
            Get in touch
          </h2>

          <p className="text-gray-200 leading-relaxed">
            At <span className="font-semibold text-xl">Bean Scene</span>, coffee is
            more than just a drink — it’s a moment of comfort and connection.
          ...
          <div className="space-y-2 text-gray-300">
            ...
            <p><strong>Email:</strong> hello@beanscene.com</p>
            <p><strong>Hours:</strong> 7:00 AM – 9:00 PM</p>
          </div>
          ...
          <div className="flex gap-5 pt-4 text-3xl">
            <a className="hover:scale-110 transition">
              <FaInstagram
                style={{
                  background:
                    "linear-gradient(45deg,#feda75,#fa7e1e,#d62976)",
